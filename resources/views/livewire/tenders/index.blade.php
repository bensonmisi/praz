...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('entity')}}">Dashboard</a></div><div class="mr-2">/</div><div class="mr-2"> Tenders</div>
</div>
...
<a href="{{route('tendershow',$notice->id)}}" class="px-3 py-6  block bg-white border shadow-md  hover:border-blue-700 hover:shadow-lg ">
