...
<div class="bg-white px-3 py-5 rounded-sm shadow-md border border-solid m-1 border-gray-200">
        ...
        <div class="px-4 py-4 flex justify-between items-center">
            <div class="text-2xl">Award Notices</div>
            <div><a href="{{route('tenders')}}" class="bg-green-600 px-3 py-3 rounded-md shadow-md text-white">New Award Notice</a></div>
        </div>
        @forelse($notices as $notice)
         <div class="px-3 py-3 text-2xl">{{$notice->tendernumber}}</div>
        <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td class="px-3 py-3 border text-center"><a href="{{route('tender',$award->notice->id)}}">{{$award->notice->tendernumber}}</a></td>
                ...
                @empty
                 <div class="px-3 py-3 text-center text-red-500">No notices found</div>
                @endforelse
