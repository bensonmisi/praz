...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('home')}}">Dashboard</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('returns')}}">Returns</a></div><div class="mr-2">/</div><div class="mr-2">Upload return</div>
</div>

<div class="bg-white px-3 py-5 rounded-sm w-3/6 mx-auto shadow-md border border-solid m-1 border-gray-200">
<div class="px-2 py-2 text-lg">Upload required procurement return </div>
