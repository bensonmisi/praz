...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.home')}}">Dashboard</a></div><div class="mr-2">/</div> <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.modules')}}">System Modules</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('can_view_submodule',$module->id)}}">Submodules</a></div><div class="mr-2">/</div><div class="mr-2">update Sub Module</div>
</div>
...
<div wire:loading wire:target='remove'>
        ...
        <div class="px-3 py-3 text-2xl border-b-2">{{$module->name}}</div>
     ...
     <div class="w-full p-3 mb-6 md:mb-0">
      ...
      <input class="appearance-none border @error('url') border-red-600 @enderror rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="url" type="text" wire:model.lazy="url">
      @error('url')
         <span class="text-red-600" role="alert">
          <strong>{{ $message }}</strong>
         </span>
