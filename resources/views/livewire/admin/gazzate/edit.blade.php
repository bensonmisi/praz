...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.home')}}">Dashboard</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.gazzate.index')}}">Gazzates</a></div><div class="mr-2">/</div><div class="mr-2">Edit Gazzate</div>
</div>
...
<div wire:loading wire:target='remove'>
        ...
        <div class="px-3 py-3 text-2xl border-b-2">Edit gazzate</div>
     ...
     <div class="w-full p-3 mb-6 md:mb-0">
      ...
      @error('to')
       ...
       @enderror
        ...
        <a href="{{route('admin.gazzate.index')}}" class="px-3 py-3 bg-red-600 rounded-md hover:bg-red-400 text-white">Cancel</a>
