...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.home')}}">Dashboard</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.sections')}}">Sections</a></div><div class="mr-2">/</div><div class="mr-2">Update Section</div>
</div>
...
<div wire:loading wire:target='remove'>
        ...
        <div class="px-3 py-3 text-2xl border-b-2">Update Section</div>
