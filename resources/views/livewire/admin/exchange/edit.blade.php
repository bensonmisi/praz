...
<div class="row justify-content-center mt-3">
    <div class="col-sm-12 col-md-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.exchange')}}"><i class="fas fa-home"></i> Exchange</a></li>
        ...
        <div class="card">
            ...
            <div class="form-group text-center">
                ...
                <div class="spinner-border" style="width: 3rem; height: 3rem;" role="status">
                  ...
                  <div class="form-group">
                        <label for="email">Other Currency</label>
                        <select class="form-control @error('other') is-invalid @enderror" id="other" wire:model.lazy="other"  required>
                            <option></option>
                             @forelse($currency as $curr)
                                <option value="{{$curr->id}}">{{$curr->name}}</option>
                             @empty
