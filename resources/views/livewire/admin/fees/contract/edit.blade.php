...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.home')}}">Dashboard</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.fees.contract')}}">Contract Fees</a></div><div class="mr-2">/</div><div class="mr-2">Update Fee</div>
</div>
     ...
     <div class="w-full p-3 mb-6 md:mb-0">
      ...
      @error('value')
       ...
       @enderror
        ...
        <a href="{{route('admin.fees.contract')}}" class="px-3 py-3 bg-red-600 rounded-md hover:bg-red-400 text-white">Cancel</a>
