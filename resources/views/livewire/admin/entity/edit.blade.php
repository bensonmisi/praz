...
<div class="bg-gray-200 px-3 py-4 rounded-md flex justify-start items-center">
       <div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.home')}}">Dashboard</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('admin.entity.index')}}">Entities</a></div><div class="mr-2">/</div><div class="text-indigo-600 px-3 py-3 mr-2"><a href="{{route('can_entity_company')}}">Companies</a></div><div class="mr-2">/</div><div class="mr-2">Update</div>
</div>
<div class="bg-white px-3 py-5 w-3/4 mx-auto rounded-sm shadow-md border border-solid m-1 border-gray-200">
        @include('partials.message')
        <div class="text-2xl px-3 py-3 text-gray-700 mt-2 mb-2">Update Organisation Details</div>
