...
<div class="px-3 py-3 text-2xl border-b border-solid border-gray-500 flex justify-between items-center">
     <div>Step2 Establishment Fee Payment</div>
     ...
     <thead>
        ...
        <tr><th class="px-3 py-3 font-bold border">SPOC Fee</th><td class="px-3 py-3 border">{{$currency}} {{$establishmentfee}}</td></tr>
          <tr><th class="px-3 py-3 font-bold">Total Due</th><td class="px-3 py-3 border-t-2 border-solid border-black text-red-600">{{$currency}} {{$establishmentfee}}</td></tr>
          ...
          <tr><th class="px-3 py-3 font-bold">Balance</th><td class="px-3 py-3 border-b-2 border-solid border-black text-red-600">{{$currency}} {{$establishmentfee-$paid}}</td></tr>
         ...
         <div class="flex justify-end items-center mt-8">
            <button class="bg-green-600 text-white px-3 py-3 rounded-sm text-center mb-6" wire:click="payESTABLISHMENT">Make Payment</button>
        </div>
</div>