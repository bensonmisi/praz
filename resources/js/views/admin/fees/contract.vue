...
import addFee from '../../../components/fees/contracts/add'
import editFee from '../../../components/fees/contracts/edit'
import deleteFee from '../../../components/fees/contracts/delete'
export default {
    components:{
     addFee,
     editFee,
