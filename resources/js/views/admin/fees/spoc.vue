...
import addFee from '../../../components/fees/spoc/add'
import editFee from '../../../components/fees/spoc/edit'
import deleteFee from '../../../components/fees/spoc/delete'
export default {
    components:{
     addFee,
     editFee,
    ...
    data(){
        ...
        getFees(){
            ...
            fee.getFees().then(response=>{
                ...
                this.$store.dispatch('setThresholdlist',response.data.threshold)
            }).catch(error=>{
                this.loading = false
