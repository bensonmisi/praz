...
import addFee from '../../../components/fees/establish/add'
import editFee from '../../../components/fees/establish/edit'
import deleteFee from '../../../components/fees/establish/delete'
export default {
    components:{
     addFee,
     editFee,
