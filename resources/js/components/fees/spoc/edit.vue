    ...
    <v-dialog v-model="addModel" max-width="600">
            ...
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-select outlined label="Select Threshold" v-model="threshold" :items="getThresholdlist" item-text="value" item-value="id" :rules="thresholdRule"></v-select>
                    <v-select outlined label="Select locality" v-model="locality" :items="localitylist" :rules="localityRule"></v-select>
