<template>
    <div>
        <v-btn fab class="blue lighten-4 white--text" small @click="addModel = true"><v-icon>mdi-pencil</v-icon></v-btn>
        ...
        <v-dialog v-model="addModel" max-width="300">
            ...
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn outlined rounded class="green" @click="updatePermission">Submit</v-btn>
                </v-card-actions>
            </v-card>
            </v-form>
        </v-dialog>
    ...
    data(){
        ...
        updatePermission(){
            if(this.$refs.form.validate()){
                ...
                permission.updatePermission(formData,this.permission.id).then(response=>{
                    this.loading = false
                    this.snackbar = true
                    this.message = "Permission successfully Updated"
                    this.color="green"
                    this.addModel = false
